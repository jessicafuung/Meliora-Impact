    ...
    <div class="privacy-page-container">
        ...
        >
            <Grid item textAlign="center" xs={12}>
              {HeadlineWithUnderline("Privacy Policy", 140, "#034f7a", 0, "#212121" ) }
            </Grid>
            <Grid item xs={6}>
                <main>
                    <section>
                    ...
                    <section>
                        <h5 className="subtitle">Information collection, use, and sharing</h5>
                        <p>We are the sole owners of the information collected on this site. We only have access to/collect information that you voluntarily give us via email or other direct contact from you. We will not sell or rent this information to anyone.
                           We will use your information to respond to you, regarding the reason you contacted us. We will not share your information with any third party outside of our organization, other than as necessary to work with you directly.
                           Unless you ask us not to, we may contact you via email in the future to tell you about changes to our services, or changes to this privacy policy.
                        </p>
                    </section>
                    <section>
                        <h5 className="subtitle">Your access and control over information</h5>
                    ...
                    <section>
                        ...
                        <p>We may request information from you on our order forms. To buy from us, you must provide contact information (like name, physical address and email address) and financial information (like credit card number, expiration date). We use an outside billing and invoicing company, and a credit card processing company to bill users for goods and services. These companies do not retain, share, store or use personally identifiable information for any secondary purposes beyond responding to your request for services. This information is used for billing purposes and to keep track of our deliverables. If we have trouble processing an order, we'll use this information to contact you.</p>
                    </section>
                    <section>
                    ...
                    <section>
                        <p>
                        If you feel that we are not abiding by this privacy policy, you should contact us immediately via email at <span style={{color: '#034f7a', textDecoration: 'underline', cursor: 'pointer',}}>legal@melioraimpact.no.</span>
                        </p>
                    </section>
                </main>
              </Grid>
