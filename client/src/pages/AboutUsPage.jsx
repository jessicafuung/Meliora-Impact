...
export function AboutUsPage() {
    ...
    return (
        <Box>
                ...
                <Grid container gap={15} alignItems="center" justifyContent="center" mb={12}>
                    <Grid item className="aboutSection">
                        <Typography variant="h6" style={{marginBottom: "30px"}}>Our vision</Typography>
                        ...
                        <Typography paragraph>
                            ...
                            allows nonprofits to carry out their frontline work.
                        </Typography>
                    </Grid>
                    <Grid item>
                        <img src={require("../images/office-ladies.png")} height="auto" alt="image"/>
                    </Grid>
                </Grid>
                <Grid container alignItems="center" justifyContent="center" mb={10}>
                    ...
                    <Grid container gap={12} alignItems="center" justifyContent="center" className="containerSection">
                        {data.map((employee) => (
