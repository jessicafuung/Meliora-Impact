...
export function CorporateMember(){
    return   <div>
        <div className="corporateHeader">
            <div>
                <p className="top">t</p>
                <p className="headline"><strong>Corporate <em>members</em></strong></p>
                <p className="description">Joining Meloria Impact gives you access to a <em>broad variety</em><br/>of <em>helpful tools</em> for tracking, statistics & more</p>
            </div>
        </div>
