...
export default function Header() {
  ...
  const { header, menuButton, toolbar, drawerContainer, paper } = useStyles();
      ...
      <Toolbar className={toolbar}>
        <a href="/">
          <p className="header-logo">
            Meliora <strong>impact</strong>
          </p>
        </a>
        <nav>
          <ul>{getMenuButtons()}</ul>
        </nav>
      </Toolbar>
    );
  };
  ...
  const displayMobile = () => {
    ...
    return (
      <AppBar
        style={{ backgroundColor: "rgba(255,238,238,0.2)", boxShadow: "none" }}
      >
        <Toolbar>
