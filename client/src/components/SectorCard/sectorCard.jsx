...
export function SectorCard({title, content, image}) {
            ...
            <Grid container flexDirection="row">
                <Card sx={{maxWidth: 500}} className="sector-card">
                   <img src={image} width={250} />
                    ...
                    <Typography fontSize={15} className="sector-content">{content} </Typography>
                    <Box alignItems="center" textAlign="center" className="sector-button">
                        <CustomButton to={"/"} variant="contained">Case study</CustomButton>
                    </Box>
                </Card>
            </Grid>
        </Box>
